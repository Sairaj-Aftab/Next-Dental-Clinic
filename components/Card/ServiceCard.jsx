...
const ServiceCard = ({ logo, title, desc }) => {
  return (
    <div className="bg-white rounded-sm p-5 flex flex-col gap-5 items-center group hover:bg-primary-color">
      <i class="fi fi-rr-tooth text-5xl bg-primary-color text-white w-24 h-24 rounded-full flex justify-center items-center group-hover:bg-secondary-text-color3"></i>
